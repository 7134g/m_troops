...
- [适配器模式](design_patterns/adapter/adapter.go)
- [单例模式](design_patterns/alone/alone.go)
- [单例方法模式](design_patterns/alone_method/alone_method.go)
- [桥接模式](design_patterns/bridge/bridge.go)
- [生成器模式](design_patterns/builder/builder.go)
- [责任链模式](design_patterns/chain_of_responsibility/chain.go)
- [命令模式](design_patterns/command/command.go)
- [组合模式](design_patterns/composite/composite.go)
- [装饰模式](design_patterns/decorator/decorator.go)
- [外观模式](design_patterns/facade/facade.go)
- [工厂模式](design_patterns/factory/factory.go)
- [工厂方法模式](design_patterns/factory_method/factorymethod.go)
- [享元模式](design_patterns/flyweight/flyweight.go)
- [解释器模式](design_patterns/interpreter/interpreter.go)
- [迭代器模式](design_patterns/iterator/iterator.go)
- [中介者模式](design_patterns/mediator/mediator.go)
- [备忘录模式](design_patterns/memento/memento.go)
- [观察者模式](design_patterns/observer/observer.go)
- [原型模式](design_patterns/prototype/prototype.go)
- [代理模式](design_patterns/proxy/proxy.go)
- [状态模式](design_patterns/state/state.go)
